...
List<LSServiceModel> getTopServiceList() {
  ...
  list.add(LSServiceModel(title: 'Smoothing', img: Smoothing));
  list.add(LSServiceModel(title: 'Make Up', img: MakeUp));
  list.add(LSServiceModel(title: 'Facial Wash', img: FacialWash));
  list.add(LSServiceModel(title: 'Hair Cut', img: HairCut));
...
List<LSServiceModel> getCatList() {
  ...
  list.add(
      LSServiceModel(title: 'Household', img: LSHouseHold, isSelected: false));
