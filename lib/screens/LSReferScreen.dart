...
class LSReferScreenState extends State<LSReferScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: appBarWidget('Refer and Earn',
          elevation: 0.0, center: true, color: context.cardColor),
        ...
        child: Column(
          children: [
            Stack(
              ...
              children: [
                commonCacheImageWidget(LSBgRefer, context.height() * 0.4,
                ...
                Positioned(
                  bottom: 16,
                  child:
                      commonCacheImageWidget(LSRefer, 180, fit: BoxFit.cover),
                )
              ],
            ),
            8.height,
