...
import 'package:calpride/main.dart';
import 'package:calpride/model/LSServiceModel.dart';
...
class LSOrderStatusScreenState extends State<LSOrderStatusScreen> {
  ...
  Widget statusView(
      String? title, String? subTitle, String? icon, String? time) {
    return Row(
      children: [
        commonCacheImageWidget(icon.validate(), 30,
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      backgroundColor: appStore.isDarkModeOn
          ...
          : LSColorSecondary,
      appBar:
          appBarWidget('Order Status', center: true, color: context.cardColor),
              ...
              child: Column(
                ...
                children: [
                  Row(
                    mainAxisAlignment: MainAxisAlignment.spaceBetween,
                    children: [
                      Text('Order No - ${widget.data!.orderNo.validate()}',
                          style: boldTextStyle()),
                  ...
                  Divider(),
                  statusView('Confirmed', 'Your order has been confirmed',
                      LSConfirm, '11:00 AM'),
                  Container(
                    height: 30,
                    width: 2,
                  ...
                  statusView('Picked Up', 'Your order has been picked up',
                      LSPickup, '12:50 PM'),
                  Container(
                    height: 30,
                    width: 2,
                  ...
                  statusView('In Process', 'Your order is now in-process',
                      LSInProgress, '06:30 PM'),
                  Container(
                    height: 30,
                    width: 2,
                    color: greenColor,
                  ...
                  statusView('Shipped', 'Your order is out of delivery',
                      LSShipping, '09:20 AM'),
                  Container(
                    height: 30,
                    width: 2,
                  ...
                  Stack(
                    children: [
                      statusView('Delivered', 'Your order has been confirmed',
                          LSWalk3, '10:30 AM'),
                      Container(
                        height: 40,
                        width: context.width(),
                ...
                children: [
                  ...
                  Column(
                    ...
                    children: [
                      ...
                      4.height,
                      Text('Call him if you have any query',
              ...
              child: Row(
                ...
                children: [
                  Container(
                    ...
                    padding: EdgeInsets.all(8),
                    child: Icon(LineIcons.facebook_messenger,
                  ...
                  Column(
                    ...
                    children: [
                      4.height,
                      Text('Message the delivery agent',
                          style: boldTextStyle()),
                      4.height,
                      Text('Message him if you have any query',
                          style: secondaryTextStyle()),
                    ],
                  ).expand()
                ],
                  ...
                  Column(
                    ...
                    children: [
                      ...
                      Text('Pick up & Delivery Address',
                          style: boldTextStyle()),
                      4.height,
                      Text(widget.data!.location.validate(),
                          style: secondaryTextStyle()),
                    ],
                  ).expand()
                ],
              ...
              child: Row(
                ...
                children: [
                  ...
                  Column(
                    ...
                    children: [
                      4.height,
                      Text('Track delivery guy\'s location',
                          style: boldTextStyle()),
                      4.height,
                      Text('He will be there at your doorstep shortly',
                          style: secondaryTextStyle()),
                    ],
                  ).expand()
                ],
            ...
            Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Row(
                    ...
                    children: [
                      Container(
                        ...
                        padding: EdgeInsets.all(16),
                        child: commonCacheImageWidget(LSWashingClothes, 50,
                  ...
                  12.height,
                  Text('1810 Cammon Realm Redwood City, CA 94063 United states',
                      style: secondaryTextStyle()),
                  8.height
                ],
              ),
