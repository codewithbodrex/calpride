...
import 'package:calpride/screens/LSSchedule/LSCompleteComponent.dart';
import 'package:calpride/screens/LSSchedule/LSDateTimeComponent.dart';
import 'package:calpride/screens/LSSchedule/LSPaymentComponent.dart';
import 'package:nb_utils/nb_utils.dart';

import '../../utils/LSColors.dart';
import 'LSLocationComponent.dart';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: SingleChildScrollView(
        child: Column(
          children: [
            LSLocationComponent().visible(
                isLocation && !isDateTime && !isPayment && !isComplete),
            LSDateTimeComponent()
                .visible(isLocation && isDateTime && !isPayment && !isComplete),
            LSPaymentComponent()
                .visible(isLocation && isDateTime && isPayment && !isComplete),
            LSCompleteComponent()
                .visible(isLocation && isDateTime && isPayment && isComplete)
