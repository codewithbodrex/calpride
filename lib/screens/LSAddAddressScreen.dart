...
import 'package:calpride/model/LSAddressModel.dart';
...
class LSAddAddressScreenState extends State<LSAddAddressScreen> {
  TextEditingController areaCont =
      TextEditingController(text: 'Phase 8,Sector 59, Mohali');
  TextEditingController addressCont = TextEditingController(
      text:
          'Plot no. E-216, First Floor, Phase 8b,Industrial Area Mohali, sector 74, Punjab 160055');
  TextEditingController contactCont =
      TextEditingController(text: '+91 987 6543 210');
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      backgroundColor: appStore.isDarkModeOn
          ...
          : LSColorSecondary,
      appBar:
          appBarWidget('Add Address', color: context.cardColor, center: true),
                    ...
                    child: RadioListTile(
                      ...
                      onChanged: (dynamic ind) {
                        setState(() {
                          ...
                          index = addressTypeList![currentTimeValue.validate()]
                              .index;
                          log(index);
                        });
                      },
                      title: Text(data.title.validate(),
