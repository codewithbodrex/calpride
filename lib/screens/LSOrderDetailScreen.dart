...
import 'package:calpride/screens/LSOrderStatusScreen.dart';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      backgroundColor: appStore.isDarkModeOn
          ...
          : LSColorSecondary,
      appBar:
          appBarWidget('Order Detail', center: true, color: context.cardColor),
              ...
              child: Column(
                ...
                children: [
                  Text('Order No - ${widget.data!.orderNo.validate()}',
                      style: boldTextStyle()),
                  4.height,
                  Text(widget.data!.date.validate(),
              ...
              child: Row(
                ...
                children: [
                  Container(
                    ...
                    child: commonCacheImageWidget(LSShipping, 40,
                  ...
                  Column(
                    ...
                    children: [
                      ...
                      4.height,
                      Text('This order is out for delivery',
                          style: secondaryTextStyle()),
                      4.height,
                      Text('View Details',
                              style: boldTextStyle(
